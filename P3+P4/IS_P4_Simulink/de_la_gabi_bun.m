...
%%
model_armax=armax(dat_id,[2,2,6,5]) % (dat_id,[nA nB nC nd) avem 4 parametrri de structura nA nB nD - care i i am gasit mai sus + nC care se ia prin incercari (nA,nB,nC,nD)
...
model_bj=bj(dat_id,[2 2 3 3 5]);
model=pem(dat_id,model_bj)
 figure,resid(model,dat_vd);
 figure,compare(model,dat_vd);
%%
